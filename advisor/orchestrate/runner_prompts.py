...
def build_runner_pool_prompt(runner_id: int, config: TeamConfig) -> str:
    ...
    return (
        ...
        "your own fix count. **The moment you finish fix "
        ...
        "fix-count proxy to trip. Big files and heavy cross-referencing "
        "eat context faster than the fix count suggests.\n\n"
